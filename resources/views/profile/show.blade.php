            ...
            <div class="flex flex-col items-start gap-2 lg:col-span-1">
                @if (Laravel\Fortify\Features::canUpdateProfileInformation())
                    <button 
                        ...
                        :class="{
                            'bg-blue-500 text-white hover:text-white dark:text-white dark:hover:text-white': selectedTab == 'profileSetteings',
                        }">
                        {{ __('Profile Settings') }}
                    </button>
                @endif
                ...
                @if (Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::updatePasswords()))
                    <button 
                        ...
                        class="block w-full max-w-xs text-left px-4 py-2 rounded-md text-gray-600 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-200" 
                        :class="{
                            'bg-blue-500 text-white hover:text-white dark:text-white dark:hover:text-white': selectedTab == 'updatePassword',
                        }">
                        {{ __('Update Password') }}
                    </button>
                @endif
                ...
                @if (Laravel\Fortify\Features::canManageTwoFactorAuthentication())
                    <button 
                        ...
                        class="block w-full max-w-xs text-left px-4 py-2 rounded-md text-gray-600 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-200" 
                        :class="{
                            'bg-blue-500 text-white hover:text-white dark:text-white dark:hover:text-white': selectedTab == 'twoFactorAuth',
                        }">
                ...
                <button 
                    ...
                    class="block w-full max-w-xs text-left px-4 py-2 rounded-md text-gray-600 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-200" 
                    :class="{
                        'bg-blue-500 text-white hover:text-white dark:text-white dark:hover:text-white': selectedTab == 'browserSessions',
                    }">
                    {{ __('Browser Sessions') }}
                </button>
                ...
                @if (Laravel\Jetstream\Jetstream::hasAccountDeletionFeatures())
                    <button 
                            ...
                            class="block w-full max-w-xs text-left px-4 py-2 rounded-md text-gray-600 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-200" 
                            :class="{
                                'bg-blue-500 text-white hover:text-white dark:text-white dark:hover:text-white': selectedTab == 'deleteProfiles',
                            }">
                            {{ __('Delete Account') }}
                        </button>
                    @endif
